...
// import styles from "./OurPatients.module.css"
...
//                     <img src={src} className="card-img-top m-2 p-2 m-auto" style={{ height: "90px", width: "75%", marginTop: "5%" }} alt="..." />
...
//                         <p className='card-Text'>{patient.contact_number}</p>
//                     </div>
//                 </div>
//             </div>
